define(function(require) {
	...
	return _.extend(new Phaser.Game(1024, 768, Phaser.AUTO, 'game', {
		...
		this.loadLevel = function(int){
		    ...
		    _this.game.style = { font: "30px Terminal", fill: "#fff", 'text-align': 'center', width: '100px'};
   	 		_this.game.tChoosePod = _this.game.add.text(Game.world.centerX/2 + 130, 320, 'Choose a time travel pod !', _this.game.style);
		};
